...
let storageFolder = 'transcriptions';

if(serverType === 'transcribe'){
  storageFolder = 'api-transcriptions';
}
...
function buildArguments ({
  ...
  if (language && !languageIsAutoDetect) arguments.push('--language', language);
  ...
  arguments.push('-o', `${storageFolder}/${numberToUse}`);
